...
model = dict(
    ...
    decode_head=dict(num_classes=124, in_channels=[320, 640, 1280, 2560]),
    auxiliary_head=dict(num_classes=124, in_channels=1280),
...
evaluation = dict(interval=12500, metric='mIoU', save_best='mIoU')
