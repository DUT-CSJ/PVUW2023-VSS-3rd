...
python3.8 tools/model_ensemble.py \
  --config ./configs/swin/upernet_swinl.py ./configs/swin/upernet_swinl.py \
  --checkpoint ./work_dirs/swin2a1002/iter_12500.pth ./work_dirs/swin2a1002/latest.pth \
  --out ./work_dirs/weightaverage \
  --gpus 0 \
