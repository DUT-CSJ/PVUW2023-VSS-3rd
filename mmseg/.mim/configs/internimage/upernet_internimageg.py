...
pretrained = './checkpoint/internimage_g_pretrainto22k_384.pth'
model = dict(
    backbone=dict(
        _delete_=True,
        type='InternImage',
    ...
    decode_head=dict(num_classes=124, in_channels=[512, 1024, 2048, 4096]),
    auxiliary_head=dict(num_classes=124, in_channels=2048),
